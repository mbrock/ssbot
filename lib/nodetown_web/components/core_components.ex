defmodule NodeTownWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NodeTownWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NodeTownWeb.Gettext, "errors", msg, opts)
    end
  end
